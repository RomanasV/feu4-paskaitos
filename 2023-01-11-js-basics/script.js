...
checkPassword('aasdasdsda');
checkPassword('aasdas#');
checkPassword('aasdas#465464654');
...
function checkStudentAge(personAge) {
  // let personAge = -5;
...
function hello(time, isLoggedIn = false, personName = '', isBirthday = false) {
...
function getPersonInfo(pName, pSurname, pAge, pJob, pGender) {
  // let pName = 'John';
  // let pSurname = 'Doe';
  // let pAge = 20;
  // let pJob = 'Developer';
...
getPersonInfo('John', 'Doe', 15, 'developer', 'male');
getPersonInfo('Steve', 'Doe', 34, 'developer', 'male');
...
function gameLevel2(pAnswer1, pAnswer2) {
  let correctAnswer21 = 1;
  let correctAnswer22 = 1;
  
  // let playerAnswer21 = pAnswer1;
  // let playerAnswer22 = pAnswer2;

  let playerAnswer21 = prompt('Pirmas klausimas (2 lygis)');
  let playerAnswer22 = prompt('Antras klausimas (2 lygis)');
...
function gameLevel3(pAnswer1, pAnswer2, pAnswer3) {
