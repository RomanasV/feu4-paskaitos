...
console.log('Perimetras: ' + (10 + 10) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 25) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 30) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 35) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 40) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 45) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 50) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 55) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 60) * 2 + ' kv. cm.');
console.log('Perimetras: ' + (10 + 120) * 2 + ' kv. cm.');
